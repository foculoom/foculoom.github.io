...
EXPECTED_PAGE_URLS = {
    ...
    ROOT / 'one-clear-path' / 'index.html': 'https://foculoom.com/one-clear-path/',
    ROOT / 'stillwater' / 'index.html': 'https://foculoom.com/stillwater/',
    ROOT / 'sortable' / 'index.html': 'https://foculoom.com/sortable/',
    ROOT / 'inkwell' / 'index.html': 'https://foculoom.com/inkwell/',
    ROOT / 'tidekeeper' / 'index.html': 'https://foculoom.com/tidekeeper/',
    ROOT / 'quiet-room' / 'index.html': 'https://foculoom.com/quiet-room/',
    ROOT / 'lantern-walk' / 'index.html': 'https://foculoom.com/lantern-walk/',
    ROOT / 'bubblepop' / 'index.html': 'https://foculoom.com/bubblepop/',
...
HTML_FILES = [
    ...
    ROOT / 'one-clear-path' / 'index.html',
    ROOT / 'stillwater' / 'index.html',
    ROOT / 'sortable' / 'index.html',
    ROOT / 'inkwell' / 'index.html',
    ROOT / 'tidekeeper' / 'index.html',
    ROOT / 'quiet-room' / 'index.html',
    ROOT / 'lantern-walk' / 'index.html',
    ROOT / 'bubblepop' / 'index.html',
    ROOT / 'support.html',
    ROOT / 'privacy.html',
    ROOT / 'terms.html',
